...
function Carousel({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }: CarouselProps) {
  ...
  return (
    <CarouselContext.Provider
      value={{ carouselRef, api, orientation: orientation || (opts?.axis === "y" ? "vertical" : "horizontal"), scrollPrev, scrollNext, canScrollPrev, canScrollNext }}
    >
      <div
...
function CarouselItem({ className, ...props }: CarouselItemProps) {
  ...
  return (
    <div
      ...
      className={cn("min-w-0 shrink-0 grow-0 basis-auto", orientation === "horizontal" ? "pl-2" : "pt-2", className)}
      {...props}
    />
  );
}
